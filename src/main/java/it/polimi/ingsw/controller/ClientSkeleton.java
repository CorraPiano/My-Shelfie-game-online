...
public interface ClientSkeleton extends Remote {
    ...
    void updateCommonGoalCard(ArrayList<CommonGoalCard> commonGoalCardslist) throws RemoteException;
    void sendPersonalGoalCard(PersonalGoalCard personalGoalCard) throws RemoteException;
}
